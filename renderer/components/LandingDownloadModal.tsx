...
export function LandingDownloadModal({ isOpen, onClose }: LandingDownloadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <div className="w-full max-w-md bg-[#18181B] border border-[#27272A] rounded-[2px] p-6 text-left relative shadow-2xl">
        {/* Header */}
        ...
        {/* Content */}
        <p className="text-[12px] font-mono text-[#A1A1AA] mb-6 leading-relaxed">
          Standalone executable bundle with precompiled native Win32 keyboard drivers. 100% offline with zero installation setup.
        </p>

        {/* 3 Step Setup Guide */}
        <div className="bg-[#111113] border border-[#27272A] rounded-[2px] p-4 space-y-3 mb-6 text-[12px] font-mono">
          <div className="flex items-start gap-3">
            <span className="text-[#00AFFF] font-bold">01 //</span>
            <p className="text-[#A1A1AA]">
              Download <code className="text-[#FFFFFF] bg-[#18181B] border border-[#27272A] px-1.5 py-0.5 rounded-[2px]">Mount-Windows-x64.zip</code> (111.9 MB)
            </p>
          </div>
          <div className="flex items-start gap-3">
